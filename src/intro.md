...
-   **You are using a version of Window**. While the bulk of this guide are not platform dependent but [Chapter 1](./ch1/0-getting-started.md) and some set up was written for Window, this is simply because I have a Window machine.
...
-   **Chapter 3** will talk about how to edit a ruleset and in general how to use and create a ruleset, add cards and everything else you need to know to use `[] json` the language rulesets are written in.
...
-   **Chapter 6 and 7** will all be more project chapters (except chapter 6 kinda). In chapter 6 we will try and recreate the `[] Detonator` sigil, chapter 7 will teach your how to create some movement sigil.
